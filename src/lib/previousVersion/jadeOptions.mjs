export default {
    ...
    publicData: {
        ...
        labels: {
            "generative": "rgb(176, 172, 249)",
            "sculpture": "rgb(192, 114, 234)",
            "code": "rgb(255, 193, 213)",
            "lighting": "rgb(252, 116, 182)",
            "web": "rgb(110, 244, 217)",
            "video": "rgb(252, 116, 182)"
        },
        projects: [
            {
                name: "About",
            ...
            },
            {
                ...
                external_path: "https://derivative.works",
            ...
            },
            {
                ...
                year: 2020,
                hide: false,
                description: "Generative video of interviews with members of the Artbreeder community about how they are using machine learning and Artbreeder in their creative practices."
            },
            {
                name: "Forms Of Life",
            ...
            },
            {
                ...
                year: 2020,
                hide: false,
                external_path: "http://www.antimander.org",
                description: "A research paper, interactive blog and open-source library for fighting gerrymandering via generative methods."
            },
            {
                ...
                labels: ["code", "web"],
                external_path: "https://joels-share.s3.amazonaws.com/rd_shapes/index.html",
            ...
            },
            {
                ...
                img2: "imgs/dod/grid_3x3.jpg",
                year: 2018,
                hide: false,
                description: "Experiments inspired by early proto-writing systems such as cuneiform and hieroglyphs. Here, new writing systems are created by challenging two neural networks to communicate information via images"
            },
            {
                name: "Ganbreeder",
                labels: ["generative", "code", "web" ],
            ...
            },
            {
                ...
                year: 2016,
                description: "Simulating the destruction of my sculptures by being dropped in a fracture simulation."
            },
            {
                name: "Table lamp 3",
                labels: ["lighting"],
